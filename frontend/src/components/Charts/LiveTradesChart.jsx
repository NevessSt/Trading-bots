...
const LiveTradesChart = ({ 
  ...
  // Memoize filtered trades calculation
  const filteredTrades = useMemo(() => {
    ...
    if (searchTerm) {
      ...
      filtered = filtered.filter(trade => 
        ...
        trade.bot_name?.toLowerCase().includes(searchLower) ||
  ...
  // Memoize new trade count calculation
...
export default memo(LiveTradesChart);