...
const MarketDataChart = ({ symbol = 'BTCUSDT' }) => {
  ...
  const formattedData = useMemo(() => formatChartData(chartData), [formatChartData, chartData]);
  ...
  const { currentPrice, priceChangePercent, isPositive } = priceStats;
...
export default memo(MarketDataChart);